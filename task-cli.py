...
list_task_parser.add_argument('list_status', choices=['todo', 'in-progress', 'done'], nargs='?',
                              help='Listing by status')
...
if args.command == 'list':
	...
	if not os.path.exists(fileName):
		print("The file does not exist. Create a new task")
	# if there is no content in the existing file
	elif os.path.getsize(fileName) == 0:
		print("There is no task in the file. Create a new task")
	else:
